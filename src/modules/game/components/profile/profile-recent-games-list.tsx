// modules/game/components/profile/profile-recent-games-list.tsx
import { Card, Button } from "@/components/ui";
import Link from "next/link";
import { DbGame } from "@/types/game";

interface ProfileRecentGamesListProps {
  games: DbGame[];
}
          ...
          return (
            ...
            >
              <div>
                ...
                <p className="text-surface-500 text-xs">Started: {started}</p>
              </div>
